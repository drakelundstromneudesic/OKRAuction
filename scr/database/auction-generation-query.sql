...
CREATE TABLE Users (
    ...
    CONSTRAINT pk_Users_User_id PRIMARY KEY (id)
);
...
CREATE TABLE Bids (
    ...
    CONSTRAINT pk_Bids_Bid_id PRIMARY KEY (id)
);
...
INSERT INTO Items (id, name, description, seller_first_name, seller_last_name, seller_email, closing_time, starting_bid, minimum_increase) 
VALUES (3, 'Drawing tablet', 'A really cool drawing tablet', 'Copper', 'Lundstrom', 'thisisfake@gmail.com', '2021-11-10 16:05:20', 200, 20);
SET IDENTITY_INSERT Items OFF


SET IDENTITY_INSERT Users ON
INSERT INTO Users (id, username, first_name, last_name, password_hash, salt, email, user_role) 
...
INSERT INTO Bids (item_id, Bidder_id, bid_timestamp, bid_amount) VALUES (1, 3, '2021-02-22 09:29:20', 25);
INSERT INTO Bids (item_id, Bidder_id, bid_timestamp, bid_amount) VALUES (1, 1, '2021-02-22 09:30:20', 35);
INSERT INTO Bids (item_id, Bidder_id, bid_timestamp, bid_amount) VALUES (1, 2, '2021-02-22 09:35:20', 100);
